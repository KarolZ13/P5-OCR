...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 14 sep. 2023 à 15:51
...
(8, 'Excellent article ! J\'ai appris tellement de choses utiles en le lisant. Merci pour le partage de ces connaissances précieuses.', 1, 1, 14, '2023-09-05', NULL),
(9, 'Ce tutoriel est incroyablement bien écrit. Les étapes sont claires et faciles à suivre. Bravo à l\'auteur !', 0, 2, 13, '2023-09-06', NULL),
(10, 'J\'adore la façon dont cet article explique les concepts complexes en les rendant accessibles à tous. Vraiment informatif !', 1, 3, 12, '2023-09-07', NULL),
(11, 'Cet article m\'a sauvé la vie ! J\'avais du mal avec ce problème depuis des jours, mais maintenant tout est clair grâce à cette explication détaillée.', 1, 4, 11, '2023-09-08', NULL),
(12, 'En tant que débutant en développement, cet article m\'a donné la confiance nécessaire pour continuer à apprendre. Merci pour l\'inspiration !', 1, 5, 10, '2023-09-09', NULL),
(13, 'Je suis un développeur expérimenté, mais je trouve toujours des astuces utiles dans vos articles. Continuez le bon travail !', 1, 6, 9, '2023-09-10', NULL),
(14, 'J\'aime la passion que l\'auteur met dans ses articles. Cela se ressent à chaque ligne. Toujours un plaisir de les lire.', 1, 7, 8, '2023-09-11', NULL),
(15, 'Cet article sur les astuces CSS est tout simplement génial. Mes projets web ont gagné en élégance grâce à vous.', 1, 1, 7, '2023-09-12', NULL),
(16, 'Je suis ravi de trouver des ressources Python de qualité comme celle-ci. Cela rend l\'apprentissage de ce langage encore plus agréable.', 0, 2, 14, '2023-09-13', NULL),
(17, 'Cet article sur le développement mobile est un incontournable pour tous les développeurs d\'applications. Merci pour les informations pratiques !', 0, 3, 13, '2023-09-14', NULL);
...
(1, 'Karol', 'Zielinski', 'karol.zielinski@laposte.net', '$2y$10$4GJ6wnftdZKiJriB.8.J4.c03Dw9is3BZltKFmDGvci6KwLLz5362', 'avatar1.jpg', 1, 1),
...
(5, 'Paul', 'LASSO', 'paul.lasso@gmail.com', '$2y$10$Jk4jW11hT/.dIJyANs2ktOSmNyTjWdD6wTKN7mxSWFfogsvc3XIIC', 'portrait-professionnel-corporate-4.jpg', NULL, NULL),
(6, 'Francois', 'Jean', 'jf@gmail.com', '$2y$10$ufL1nZ5kpF0BGNE3seuzDOTOAv7Abi29fYjSu7lHwhat66XqDRnti', 'Photo-portrait-avocat.jpg', 0, 1),
(7, 'nooo', 'booo', 'bo.no@gmail.com', '$2y$10$SFo86BSdMB3KPAP0O3ZXd.Cde.LE2/K3wtA7JKHiSOvaMS8U22dMq', 'portrait-corporate-6.jpg', 0, 1);
